...
const EnquiryCard = () => {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_BASE_URL}/api/enquiries/enquiry-card`);
  ...
  const cardsData = [
    ...
    {
      title: "Selected Enquiries",
      count: stats.selectedEnquiries,
